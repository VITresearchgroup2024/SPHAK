...
# Save results
with open('animal_reference_database.pkl', 'wb') as f: #change the name if needed
    pickle.dump({'family_kmers': dict(family_kmers), 'total_kmers': dict(total_kmers)}, f)

print("Filtered k-mers with occurrences and total k-mer counts saved to 'animal_reference_database.pkl'") 
