...
# === Load dataset ===
animal = pd.read_csv("/content/animal_out_of_sample_result.csv", sep=",")
...
plt.savefig('scatterplot_animal.png', dpi=1200, bbox_inches='tight')
plt.savefig('scatterplot_animal.pdf', bbox_inches='tight')
